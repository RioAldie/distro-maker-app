...
export default function Home() {
  return (
    <div className="bg-slate-50 grainy-light">
      ...
      <section className="bg-slate-100 mt-40 grainy-dark py-24">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  on the design. Had the case for two and a half
                  months now and{' '}
                  <span className="p-0.5 bg-slate-800 text-white">
                    the image is super clear
                  </span>
                  , on the case I had before, the image started fading
                  into yellow-ish color after a couple weeks. Love
                  it."
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  pocket and that led to some pretty heavy
